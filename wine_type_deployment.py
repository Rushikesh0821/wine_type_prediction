...
Original file is located at
    https://colab.research.google.com/drive/1cFmJGPdiuU8IePq9yPgSe6gmx8xg9xy9
"""
...
df= ps.DataFrame({
    ...
    "chlorides":[chlorides],
    "free sulfur_dioxide":[free_sulfur_dioxide],
    "total sulfur_dioxide":[total_sulfur_dioxide],
    "density":[density],
    "pH":[pH],
    "sulphates":[sulphates],
    "alcohol":[alcohol],
